  ...
  return (
    ...
    <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
      <div className="absolute inset-0 bg-zinc-900">
        <Image
          src="/placeholder.svg?height=800&width=800&text=StyleStore"
          fill
      ...
      <div className="relative z-20 mt-auto">
        <blockquote className="space-y-2">
          <p className="text-lg">
            "StyleStore has completely transformed my shopping experience. The quality of products and the ease of use
            make it my go-to destination for fashion."
          </p>
